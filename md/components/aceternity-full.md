# Aceternity UI — Full Component Source Code

> Scraped: 2026-05-28T04:22:53.012Z
> Total: 71

---

## Aceternity: Webcam Pixel Grid

A real-time webcam pixel grid effect, perfect for pixel art and retro aesthetics.
> Source: https://ui.aceternity.com/components/webcam-pixel-grid
...
## Aceternity: Images Badge

A badge with images that can be hovered to reveal more images.
> Source: https://ui.aceternity.com/components/images-badge
...
> Source: https://ui.aceternity.com/components/ascii-art
...
> Source: https://ui.aceternity.com/components/comet-card
...
> Source: https://ui.aceternity.com/components/direction-aware-hover
...
> Source: https://ui.aceternity.com/components/encrypted-text
...
> Source: https://ui.aceternity.com/components/colourful-text
> Dependencies: motion/react
...
## Aceternity: Text Reveal Card

Mousemove effect to reveal text content at the bottom of the card.
> Source: https://ui.aceternity.com/components/text-reveal-card
...
> Source: https://ui.aceternity.com/components/stateful-button
...
> Source: https://ui.aceternity.com/components/dither-shader
...
> Source: https://ui.aceternity.com/components/link-preview
> Dependencies: motion/react
...
> Source: https://ui.aceternity.com/components/images-slider
> Dependencies: motion/react
...
> Source: https://ui.aceternity.com/components/carousel
...
> Source: https://ui.aceternity.com/components/layout-grid
...
> Source: https://ui.aceternity.com/components/container-cover
...
> Source: https://ui.aceternity.com/components/following-pointer
...
> Source: https://ui.aceternity.com/components/pointer-highlight
...
> Source: https://ui.aceternity.com/components/3d-globe
...
## Aceternity: 3D Pin
> Source: https://ui.aceternity.com/components/3d-pin
...
> Source: https://ui.aceternity.com/components/feature-sections-free
> Dependencies: cobe, motion/react, @tabler/icons-react
...
> Source: https://ui.aceternity.com/components/cards-free
> Dependencies: motion/react
...
> Source: https://ui.aceternity.com/components/hero-sections-free
> Dependencies: motion/react
...
Mouse-driven parallax effect, perfect for hero sections. Images blur fade in and move at different depths.**: page.goto: Timeout 30000ms exceeded.
Call log:
[2m  - navigating to "https://ui.aceternity.com/components/parallax-hero-images", waiting until "networkidle"[22m

- **Scales

A repeating diagonal, horizontal, or vertical line pattern background effect.**: page.goto: Timeout 30000ms exceeded.
Call log:
[2m  - navigating to "https://ui.aceternity.com/components/scales", waiting until "networkidle"[22m

- **Dotted Glow Background

A background effect with opacity animation, glow effect and more.**: page.goto: Timeout 30000ms exceeded.
Call log:
[2m  - navigating to "https://ui.aceternity.com/components/dotted-glow-background", waiting until "networkidle"[22m

- **Background Ripple Effect

A grid of cells that ripple when clicked.**: page.goto: Timeout 30000ms exceeded.
Call log:
[2m  - navigating to "https://ui.aceternity.com/components/background-ripple-effect", waiting until "networkidle"[22m

- **Sparkles**: page.goto: net::ERR_TIMED_OUT at https://ui.aceternity.com/components/sparkles
Call log:
[2m  - navigating to "https://ui.aceternity.com/components/sparkles", waiting until "networkidle"[22m

- **Background Gradient

An animated gradient that sits at the background of a card, button or anything.**: page.goto: Navigation to "https://ui.aceternity.com/components/background-gradient" is interrupted by another navigation to "chrome-error://chromewebdata/"
Call log:
[2m  - navigating to "https://ui.aceternity.com/components/background-gradient", waiting until "networkidle"[22m

- **Background Gradient Animation

A smooth and elegant background gradient animation that changes the gradient position over time.**: page.goto: Timeout 30000ms exceeded.
Call log:
[2m  - navigating to "https://ui.aceternity.com/components/background-gradient-animation", waiting until "networkidle"[22m

- **Wavy Background**: page.goto: Timeout 30000ms exceeded.
Call log:
[2m  - navigating to "https://ui.aceternity.com/components/wavy-background", waiting until "networkidle"[22m

- **Background Boxes

A full width background box container that highlights on hover**: page.goto: Timeout 30000ms exceeded.
Call log:
[2m  - navigating to "https://ui.aceternity.com/components/background-boxes", waiting until "networkidle"[22m

- **Background Beams**: page.goto: Timeout 30000ms exceeded.
Call log:
[2m  - navigating to "https://ui.aceternity.com/components/background-beams", waiting until "networkidle"[22m

- **Background Beams With Collision

Exploding beams in the background**: page.goto: Timeout 30000ms exceeded.
Call log:
[2m  - navigating to "https://ui.aceternity.com/components/background-beams-with-collision", waiting until "networkidle"[22m

- **Background Lines

A set of svg paths that animate in a wave pattern. Good for hero sections background, as seen on height.app**: page.goto: Timeout 30000ms exceeded.
Call log:
[2m  - navigating to "https://ui.aceternity.com/components/background-lines", waiting until "networkidle"[22m

- **Aurora Background**: page.goto: Timeout 30000ms exceeded.
Call log:
[2m  - navigating to "https://ui.aceternity.com/components/aurora-background", waiting until "networkidle"[22m

- **Meteor Effect

A group of beams in the background of a container, sort of like meteors.**: page.goto: Navigation to "https://ui.aceternity.com/components/meteors" is interrupted by another navigation to "chrome-error://chromewebdata/"
Call log:
[2m  - navigating to "https://ui.aceternity.com/components/meteors", waiting until "networkidle"[22m

- **Glowing Background Stars Card

Card background stars that animate on hover and animate anyway**: page.goto: Navigation to "https://ui.aceternity.com/components/glowing-stars-effect" is interrupted by another navigation to "https://ui.aceternity.com/components/meteors"
Call log:
[2m  - navigating to "https://ui.aceternity.com/components/glowing-stars-effect", waiting until "networkidle"[22m

- **Shooting Stars and Stars Background

A shooting star animation on top of a starry background, as seen on figmaplug.in**: page.goto: Timeout 30000ms exceeded.
Call log:
[2m  - navigating to "https://ui.aceternity.com/components/shooting-stars-and-stars-background", waiting until "networkidle"[22m

- **Vortex Background

A wavy, swirly, vortex background ideal for CTAs and backgrounds.**: page.goto: Timeout 30000ms exceeded.
Call log:
[2m  - navigating to "https://ui.aceternity.com/components/vortex", waiting until "networkidle"[22m

- **Spotlight

A spotlight effect with Tailwind CSS, good for drawing attention to a particular element on the page.**: page.goto: Timeout 30000ms exceeded.
Call log:
[2m  - navigating to "https://ui.aceternity.com/components/spotlight", waiting until "networkidle"[22m

- **Spotlight New

A new spotlight component with left and right spotlight, configurable and customizable.**: page.goto: Timeout 30000ms exceeded.
Call log:
[2m  - navigating to "https://ui.aceternity.com/components/spotlight-new", waiting until "networkidle"[22m

- **Canvas Reveal Effect

A dot background that expands on hover, as seen on Clerk's website**: page.goto: Timeout 30000ms exceeded.
Call log:
[2m  - navigating to "https://ui.aceternity.com/components/canvas-reveal-effect", waiting until "networkidle"[22m

- **SVG Mask Effect

A mask reveal effect, hover the cursor over a container to reveal what's underneath.**: page.goto: Timeout 30000ms exceeded.
Call log:
[2m  - navigating to "https://ui.aceternity.com/components/svg-mask-effect", waiting until "networkidle"[22m

- **Tracing Beam**: page.goto: Timeout 30000ms exceeded.
Call log:
[2m  - navigating to "https://ui.aceternity.com/components/tracing-beam", waiting until "networkidle"[22m

- **Lamp Effect**: page.goto: Timeout 30000ms exceeded.
Call log:
[2m  - navigating to "https://ui.aceternity.com/components/lamp-effect", waiting until "networkidle"[22m

- **Google Gemini Effect

An effect of SVGs as seen on the Google Gemini Website**: page.goto: Timeout 30000ms exceeded.
Call log:
[2m  - navigating to "https://ui.aceternity.com/components/google-gemini-effect", waiting until "networkidle"[22m

- **Keyboard

A mac style keyboard component with mechanical keys sound effects.**: page.goto: Timeout 30000ms exceeded.
Call log:
[2m  - navigating to "https://ui.aceternity.com/components/keyboard", waiting until "networkidle"[22m

- **Terminal

A mac style terminal component with bash syntax highlighting and typewriter effect.**: page.goto: Timeout 30000ms exceeded.
Call log:
[2m  - navigating to "https://ui.aceternity.com/components/terminal", waiting until "networkidle"[22m

- **Tooltip Card

A tooltip card container that follows mouse pointer when hovered over**: page.goto: Timeout 30000ms exceeded.
Call log:
[2m  - navigating to "https://ui.aceternity.com/components/tooltip-card", waiting until "networkidle"[22m

- **Pixelated Canvas

Convert any image to a pixelated canvas mouse distortion effects, as seen on Tailwind CSS Website.**: No code found
- **3D Card Effect**: page.goto: Timeout 30000ms exceeded.
Call log:
[2m  - navigating to "https://ui.aceternity.com/components/3d-card-effect", waiting until "networkidle"[22m

- **Evervault Card

A cool card with amazing hover effect, reveals encrypted text and a mixed gradient.**: page.goto: Timeout 30000ms exceeded.
Call log:
[2m  - navigating to "https://ui.aceternity.com/components/evervault-card", waiting until "networkidle"[22m

- **Draggable Card

A tiltable, draggable card component that jumps on bounds.**: page.goto: Timeout 30000ms exceeded.
Call log:
[2m  - navigating to "https://ui.aceternity.com/components/draggable-card", waiting until "networkidle"[22m

- **Parallax Scroll**: page.goto: Timeout 30000ms exceeded.
Call log:
[2m  - navigating to "https://ui.aceternity.com/components/parallax-scroll", waiting until "networkidle"[22m

- **Text Flipping Board

A split-flap display component that animates characters with flip transitions, inspired by Vestaboard.**: page.goto: Timeout 30000ms exceeded.
Call log:
[2m  - navigating to "https://ui.aceternity.com/components/text-flipping-board", waiting until "networkidle"[22m

- **Magnetic Button

A button that subtly drifts toward the cursor as you hover, with a spring-based return when you leave.**: page.goto: Timeout 30000ms exceeded.
Call log:
[2m  - navigating to "https://ui.aceternity.com/components/magnetic-button", waiting until "networkidle"[22m

- **Noise Background

A dynamic background effect with animated gradients, noise texture, and smooth motion.**: page.goto: Timeout 30000ms exceeded.
Call log:
[2m  - navigating to "https://ui.aceternity.com/components/noise-background", waiting until "networkidle"[22m

- **Tailwind CSS buttons

A curated list of awesome, battle tested Tailwind CSS buttons components**: page.goto: Timeout 30000ms exceeded.
Call log:
[2m  - navigating to "https://ui.aceternity.com/components/tailwindcss-buttons", waiting until "networkidle"[22m

- **Globe**: page.goto: Timeout 30000ms exceeded.
Call log:
[2m  - navigating to "https://ui.aceternity.com/components/github-globe", waiting until "networkidle"[22m
